 ...
 * Date       : Oct. 6. 2016
 *
 * I added three varibles' initilization (fetch_wait_time, pack_wait_time
 * 						& total_time)
 *
 */
...
Order Parser::read_order() {
	...
	cached_order.fetch_wait_time = 0; //initialize the values that I added
	cached_order.pack_wait_time = 0; // They will be modified in main.cpp
	cached_order.total_time = 0;
	cached_order.start_time = 0;
        cached_order.print = 0;
	return order;
}
